import { Inventario } from "./ejercicio1";
import { EquipoFactory } from "./ejercicio2";
import { Equipo, Soporte } from "./ejercicio3";
import { InventarioViejo, AdaptadorInventario } from "./ejercicio4";
